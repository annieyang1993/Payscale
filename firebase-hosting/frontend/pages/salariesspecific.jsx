...
function Stats({companyName, title, division, yoe, title1}){
    ...
    return (
        ...
        <div className = 'stats' onClick={()=>{}}>
            ...
            <div className = 'percentile-wrapper-specific'>

            <h2 >Median Salary and Compensation Package for {title1}</h2>
            ...
            <h2 >10th Percentile Compensation for {title1}</h2>
            ...
            <div className = 'percentile-wrapper-specific' onClick={()=>{ ninetyPercentExpand ? setNinetyPercentExpand(false) : setNinetyPercentExpand(true)}}>

                <h2 >90th Percentile Compensation for {title1}</h2>
...
function Salaries(){
    ...
    const filterJob = (job, i, n) =>{
        ...
        if (job.live === false){
            ...
            included = false;
        } else if (authContext.careerFilter!==null && authContext.careerFilter!=='' && job.career_type.toLowerCase() !== authContext.careerFilter.toLowerCase()){
            if (job.career_type_other === null || job.career_type_other.toLowerCase() !== authContext.careerFilter.toLowerCase()){
                included = false;
            }
    ...
    'Private Equity', 'FP&A']
    var title1 = roles[Number(url[url.length-1])]
    ...
    useEffect(async () => {
        ...
        if (url[url.length-1]==="salaries"){
            ...
            authContext.setCareerFilter(roles[Number(url[url.length-1])]);
        }
    ...
    return(
        <div className = 'content'>
            ...
            <div className = 'under-header'>
                ...
                <div className = 'under-header-inner'>

                <h1 className = 'specific-title'>{title1} Salary and Compensation Data</h1>

                <div className = 'salary-specific-left'>
                    <Stats companyName={companyName} title={title} division={authContext.careerFilter} yoe={yoe} title1={title1}/>
                </div>


                <div className = 'salary-specific-right'>
                ...
                <div className = 'filters'>
                    <div className = 'salary-info-2'>
                        ...
                        <div className = 'dropdown-container-specific'>
                            <div for="contract" className = 'dropdown-label-jobs'>Title:</div>
                                <Select
                                    ...
                                    isMulti={false}
                                />
                            </div> : <div className = 'dropdown-container-specific'>
                            <div for="contract" className = 'dropdown-label-jobs'>Title:</div>
                                <Select
                                    value={null} 
                                    className = 'select-dropdown-jobs' 
                    ...
                    <div style={{width: '100%', textAlign: 'center', marginTop: '20px'}}>- tap entry to view more information -</div>
